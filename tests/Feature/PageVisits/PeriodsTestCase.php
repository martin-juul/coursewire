...
class PeriodsTestCase extends TestCase
{
    ...
    public function day_test()
    {
        ...
        $this->assertEquals(
            1,
            visits('Tests\Feature\PageVisits\Post')->period('day')->timeLeft()
        );
        ...
        //time until redis delete periods
        $this->assertEquals(1, now()->addSeconds(visits('Tests\Feature\PageVisits\Post')->period('day')->timeLeft())->diffInDays($time));
    }
    ...
    public function total_periods()
    {
        ...
        $this->assertEquals([2, 2, 2, 2, 2], [
            ...
            visits('Tests\Feature\PageVisits\Post')->period('day')->count(),
            visits('Tests\Feature\PageVisits\Post')->period('week')->count(),
            visits('Tests\Feature\PageVisits\Post')->period('month')->count(),
            visits('Tests\Feature\PageVisits\Post')->period('year')->count(),
        ]);
