...
var BaseTransport = /** @class */ (function () {
    ...
    BaseTransport.prototype._handleResponse = function (_a) {
        ...
        if (limited)
            _sentry_utils__WEBPACK_IMPORTED_MODULE_3__["logger"].warn("Too many requests, backing off till: " + this._disabledUntil(requestType));
...
/*!*************************************************************!*\
  !*** ./node_modules/@sentry/tracing/esm/browser/request.js ***!
  \*************************************************************/
/*! exports provided: DEFAULT_TRACING_ORIGINS, defaultRequestInstrumentionOptions, registerRequestInstrumentation, fetchCallback, xhrCallback */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var getTTFB = function (onReport) {
    var metric = Object(_lib_initMetric__WEBPACK_IMPORTED_MODULE_0__["initMetric"])('TTFB');
    afterLoad(function () {
        try {
...
/* harmony import */ var _sentry_hub__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @sentry/hub */ "./node_modules/@sentry/hub/esm/index.js");
/* harmony import */ var _sentry_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @sentry/utils */ "./node_modules/@sentry/utils/esm/index.js");
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./errors */ "./node_modules/@sentry/tracing/esm/errors.js");
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils */ "./node_modules/@sentry/tracing/esm/utils.js");
...
function sample(hub, transaction, samplingContext) {
    ...
    if (!client || !Object(_utils__WEBPACK_IMPORTED_MODULE_6__["hasTracingEnabled"])(options)) {
...
function getDefaultSamplingContext(transactionContext) {
    ...
    if (Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_2__["isNodeEnv"])()) {
        ...
        if (domain) {
            ...
            // and compare types
            var nodeHttpModule = Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_2__["dynamicRequire"])(module, 'http');
            // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
            var requestType_1 = nodeHttpModule.IncomingMessage;
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            var request = domain.members.find(function (member) { return Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_2__["isInstanceOf"])(member, requestType_1); });
            if (request) {
                defaultSamplingContext.request = Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_2__["extractNodeRequestData"])(request);
            }
        }
    }
    // we must be in browser-js (or some derivative thereof)
        ...
        var globalObject = Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_2__["getGlobalObject"])();
...
function _startTransaction(transactionContext, customSamplingContext) {
    var transaction = new _transaction__WEBPACK_IMPORTED_MODULE_5__["Transaction"](transactionContext, this);
...
function addExtensionMethods() {
    ...
    Object(_errors__WEBPACK_IMPORTED_MODULE_3__["registerErrorInstrumentation"])();
}
...
/*!***************************************************!*\
  !*** ./node_modules/@sentry/tracing/esm/index.js ***!
  \***************************************************/
/*! exports provided: Integrations, Span, Transaction, SpanStatus, addExtensionMethods, extractTraceparentData, getActiveTransaction, hasTracingEnabled, stripUrlQueryAndFragment */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("v-tab", { attrs: { href: "/" } }, [_vm._v("Hjem")]),
          _vm._v(" "),
...
if (sentryDsn && sentryDsn !== '') {
  _sentry_browser__WEBPACK_IMPORTED_MODULE_2__["init"]({
    dsn: sentryDsn,
    integrations: [new _sentry_integrations__WEBPACK_IMPORTED_MODULE_3__["Vue"]({
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('masthead', __webpack_require__(/*! ./components/masthead */ "./resources/js/components/masthead.vue")["default"]);
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('impressum', __webpack_require__(/*! ./components/impressum */ "./resources/js/components/impressum.vue")["default"]);
...
var opts = {
  theme: {
    background: '#ddd',
    primary: vuetify_es5_util_colors__WEBPACK_IMPORTED_MODULE_2___default.a.blue.base,
    secondary: vuetify_es5_util_colors__WEBPACK_IMPORTED_MODULE_2___default.a.blue.lighten2,
    ...
    info: vuetify_es5_util_colors__WEBPACK_IMPORTED_MODULE_2___default.a.blue.base,
