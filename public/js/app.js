  ...
  methods: {
    ...
    onStudentType: function onStudentType(studentType) {
      ...
      var done = function done() {
        _this5.getSemesters().then(function () {
          return _this5.step = 3;
        })["catch"](function (e) {
          vm.error = true;
          vm.loading = false;
          throw e;
    ...
    getSemesters: function getSemesters() {
      ...
      return new Promise(function (resolve, reject) {
        var vm = _this6;
        _services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].educationVersion(_this6.selectedEducationType.slug).then(function (res) {
          var educationSlug = res.data.data.slug;
          _services_api_service__WEBPACK_IMPORTED_MODULE_3__["default"].semesters(educationSlug, _this6.selectedStudentType.slug).then(function (res) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      !_vm.loading && !_vm.error && _vm.educations.length > 0
        ? _c(
            "v-row",
                    ...
                    [
                      _c(
                        "v-card",
                        {
                          ...
                          attrs: { color: _vm.getRandomColor(), dark: "" }
                        },
                        [
                          _c("v-card-title", [
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      colorWheelIdx: 0,
      colorWheelColors: ['blue', 'indigo', 'purple', 'pink', 'red', 'orange', 'yellow', 'green', 'teal', 'cyan']
    };
  },
  methods: {
